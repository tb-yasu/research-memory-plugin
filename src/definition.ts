...
export const TOOL_DEFINITION = {
  ...
  parameters: {
    ...
    properties: {
      kind: { type: "string", enum: ["list", "read", "save", "update", "delete", "citationTable", "relatedWork", "export", "getProfile", "setProfile", "fetchMetadata", "mergePapers"], description: "Operation. Default: list." },
